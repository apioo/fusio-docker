...
LABEL org.opencontainers.image.version="6.2.0"
...
ARG FUSIO_VERSION="6.2.0"
ARG FUSIO_APP_BACKEND="6.2.0"
ARG FUSIO_APP_DEVELOPER="6.2.0"
ARG FUSIO_APP_ACCOUNT="2.2.0"
