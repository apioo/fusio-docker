...
return [
    ...
    'fusio_php_sandbox'       => env('FUSIO_PHP_SANDBOX')->bool(),
    ...
    // the backend
    'fusio_marketplace'       => env('FUSIO_MARKETPLACE')->bool()->default(false),
    ...
    'psx_env'                 => env('FUSIO_ENV')->string()->default('prod'),
    ...
    'psx_debug'               => env('FUSIO_DEBUG')->bool()->default(false),
